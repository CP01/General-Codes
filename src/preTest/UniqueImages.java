...
class UniqueImages {
    public static class Image {
        ...
        public boolean equals(Object other) {
            ...
            String[] ocomponents = o.filename.toLowerCase().split("\\.");
		...
		public int hashCode() {
			final int prime = 31;
			int result = 1;
			result = prime * result + ((filename == null) ? 0 : filename.toLowerCase().substring(0,filename.indexOf('.')).hashCode());
    ...
    public static void main(String[] args) {
        ...
        UniqueImages u = new UniqueImages();
    }
}
